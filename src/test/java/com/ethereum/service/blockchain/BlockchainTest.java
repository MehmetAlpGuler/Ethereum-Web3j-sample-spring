package com.ethereum.service.blockchain;
...
public class BlockchainTest {
    ...
    public void test() throws CipherException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException, IOException {
        ...
        String file = WalletUtils.generateFullNewWalletFile("test123", null);
        Credentials c = WalletUtils.loadCredentials("test123", file);
